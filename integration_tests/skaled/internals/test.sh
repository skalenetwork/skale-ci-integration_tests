...
case "$TEST_NAME" in
      ...
      "test_node_rotation")
            ...
            sudo -E ../../create_btrfs.sh; sudo -E NO_ULIMIT_CHECK=1 DATA_DIR=btrfs HISTORIC_SKTEST_EXE=${SKTEST_EXE}-historic ./venv/bin/python3 -m pytest -s -x 'test_node_rotation.py::test_download_from_archive_to_core'
      ;;

...
case "$TEST_NAME" in
      ...
      "test_snapshot_api")
            ...
            sudo -E ../../create_btrfs.sh; sudo -E NO_ULIMIT_CHECK=1 DATA_DIR=btrfs catchupIntervalMs=1000000000 ./venv/bin/python3 -m pytest -s 'test_snapshot_api.py::test_download_download'
